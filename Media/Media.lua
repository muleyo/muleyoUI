...
-- Status
--LSM:Register("statusbar", "Flat", [[Interface\Addons\MUI\Media\Textures\Status\Flat.blp]])
...
--LSM:Register("statusbar", "Minimalist", [[Interface\Addons\MUI\Media\Textures\Status\Minimalist.tga]])
--LSM:Register("statusbar", "Smooth", [[Interface\Addons\MUI\Media\Textures\Status\Smooth.blp]])
