    ...
    MapMinimap.layout = {
        ...
        args = {
            enable = {
                ...
                get = function()
                    return mUI.db.profile.map.enabled
                end,
                order = 1
            },
            header1 = {
            ...
            minimap = {
                ...
                get = function()
                    return mUI.db.profile.map.minimap
                end,
                order = 5
            },
            clock = {
                ...
                get = function()
                    return mUI.db.profile.map.clock
                end,
                order = 6
            },
            date = {
                ...
                get = function()
                    return mUI.db.profile.map.date
                end,
                order = 7
            },
            tracking = {
                ...
                get = function()
                    return mUI.db.profile.map.tracking
                end,
                order = 8
            },
            buttons = {
                ...
                get = function()
                    return mUI.db.profile.map.buttons
                end,
                order = 9
            }
        }
