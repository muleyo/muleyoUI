    ...
    Castbars.layout = {
        ...
        args = {
            enabled = {
                ...
                get = function()
                    return mUI.db.profile.castbars.enabled
                end,
                order = 1
            },
            header1 = {
            ...
            style = {
                ...
                set = function(_, val)
                    ...
                    if not Castbars.Module:IsEnabled() then
                        return
                    end
                ...
                get = function()
                    return mUI.db.profile.castbars.style
                end,
                order = 3
            },
            texture = {
                ...
                set = function(_, val)
                    ...
                    Castbars.Module.Texture:Update()
                end,
                get = function()
                    return mUI.db.profile.castbars.texture
                end,
                order = 4
            },
            icons = {
                ...
                get = function()
                    return mUI.db.profile.castbars.icon
                end,
                order = 5
            },
            casttime = {
                ...
                get = function()
                    return mUI.db.profile.castbars.casttime
                end,
                order = 6
            },
            header2 = {
            ...
            targetscale = {
                ...
                get = function()
                    return mUI.db.profile.castbars.targetscale
                end,
                order = 8
            },
            focusscale = {
                ...
                get = function()
                    return mUI.db.profile.castbars.focusscale
                end,
                order = 9
            },
            header3 = {
            ...
            targetpos = {
                ...
                get = function()
                    return mUI.db.profile.castbars.targetpos
                end,
                order = 11
            },
            focuspos = {
                ...
                get = function()
                    return mUI.db.profile.castbars.focuspos
                end,
                order = 12
            }
        }
