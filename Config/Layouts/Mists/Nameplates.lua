    ...
    Nameplates.layout = {
        ...
        args = {
            ...
            totem = {
                ...
                type = "toggle",
                set = function(_, val)
                    mUI.db.profile.nameplates.totemicons = val
                ...
                get = function()
                    return mUI.db.profile.nameplates.totemicons
                end,
                order = 10
            },
            casttime = {
                ...
                type = "toggle",
                set = function(_, val)
                    mUI.db.profile.nameplates.casttime = val
                end,
                get = function()
                    return mUI.db.profile.nameplates.casttime
                end,
                order = 11
            },
            focus = {
