...
local MAJOR, MINOR = "AceConfigDialog-3.0-mUI", 87
...
AceConfigDialog.tooltip = AceConfigDialog.tooltip or
                              CreateFrame("GameTooltip", "AceConfigDialogTooltip-mUI", UIParent, "GameTooltipTemplate")
        ...
        if not hidden then
            if v.type == "group" then
                ...
                if v.type == "execute" then
                    ...
                    control = CreateControl(v.dialogControl or v.control, iconControl and "Icon" or "mUI_Button")
                    if iconControl then
                        if not width then
                ...
                elseif v.type == "input" then
                    control = CreateControl(v.dialogControl or v.control,
                        v.multiline and "mUI_MultiLineEditBox" or "mUI_EditBox")
                ...
                elseif v.type == "toggle" then
                    control = CreateControl(v.dialogControl or v.control, "mUI_Checkbox")
                    control:SetLabel(name)
                ...
                elseif v.type == "range" then
                    control = CreateControl(v.dialogControl or v.control, "mUI_Slider")
                    control:SetLabel(name)
                ...
                elseif v.type == "select" then
                    ...
                    if v.style == "radio" then
                        ...
                        control = gui:Create("mUI_InlineGroup")
                        ...
                        for _, value in ipairs(sorting) do
                            ...
                            local radio = gui:Create("mUI_Radio")
                            radio:SetLabel(text)
                        ...
                        control = CreateControl(v.dialogControl or v.control, "mUI_Dropdown")
...
function AceConfigDialog:FeedGroup(appName, options, container, rootframe, path, isRoot)
    ...
    for k, v in pairs(group.args) do
        if v.type == "group" and not pickfirstset(v.dialogInline, v.guiInline, v.inline, false) and
    ...
    if hasChildGroups and not inline then
        ...
        if grouptype == "tab" then
            ...
            for i = 1, #tabs do
                ...
                if not entry.disabled then
                    tab:SelectTab((GroupExists(appName, options, path, status.groups.selected) and
                                      status.groups.selected) or entry.value)
                    break
                end
            end
        ...
        elseif grouptype == "select" then
            ...
            if firstgroup then
                selectGroup:SetGroup((GroupExists(appName, options, path, status.groups.selected) and
                                         status.groups.selected) or firstgroup)
            end
        ...
        elseif (parenttype ~= "tree") or isRoot then
            ...
            for i = 1, #treedefinition do
                ...
                if not entry.disabled then
                    tree:SelectByValue((GroupExists(appName, options, path, status.groups.selected) and
                                           status.groups.selected) or entry.value)
                    break
                end
            end
