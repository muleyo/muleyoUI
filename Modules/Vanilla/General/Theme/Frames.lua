...
function Theme:Unitframes()
    -- Unitframes
    mUI:Skin({PlayerFrameTexture, PlayerFrameVehicleTexture, PetFrameTexture, TargetFrameTextureFrameTexture, Boss1TargetFrameTextureFrameTexture,
...
function Theme:Frames()
    ...
    mUI:Skin(StaticPopup1.EditBox.NineSlice)
    mUI:Skin(StaticPopup2.EditBox.NineSlice)
    mUI:Skin(StaticPopup3.EditBox.NineSlice)
