...
function Theme:ClassBar()
    ...
    elseif (playerClass == "DEATHKNIGHT") then
        -- Death Knight
        if mUI:IsClassic() then
            mUI:Skin({Rune1BorderTexture, Rune2BorderTexture, Rune3BorderTexture, Rune4BorderTexture,
                      Rune5BorderTexture, Rune6BorderTexture}, true)
        else
    ...
    elseif (playerClass == "PALADIN") then
        ...
        if mUI:IsClassic() then
            ...
            mUI:Skin({PaladinPowerBarFrame.Background, PaladinPowerBarFrame.ActiveTexture,
                      ClassNameplateBarPaladinFrame.Background, ClassNameplateBarPaladinFrame.ActiveTexture}, true)
        end
